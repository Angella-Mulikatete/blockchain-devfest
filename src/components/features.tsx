...
export default function Features() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setTab((prevTab) => (prevTab % 3) + 1); // Cycle through 1 → 2 → 3 → 1
    }, intervalTime);
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:grid md:grid-cols-12 md:gap-8">
            ...
            <div className="mb-8 md:mb-0 space-y-4">
              {[
                  { 
                    id: 1, 
                    title: 'Community', 
                    description: 'Forge valuable connections with fellow attendees who share your interests and aspirations. Share knowledge, insights, and experiences with others in the community, fostering growth and development.', 
                    img: '/assets/images/comm.jpeg' , 
                    icon: (
                    <svg
                ...
                <button
                  ...
                  className={`flex items-center text-left w-full p-6 rounded-lg transition-all duration-300 ease-in-out transform ${
                    tab === item.id ? 'bg-white shadow-lg border-transparent scale-105' : 'bg-gray-50 hover:bg-white hover:shadow-md'
                  }`}
          ...
          <div className="max-w-xl md:w-full mx-auto md:col-span-5 lg:col-span-6" ref={tabs}>
            {[
              { id: 1, img: '/assets/images/comm.jpeg' , alt: 'Community' },
              { id: 2, img: '/assets/images/share.jpeg', alt: 'Talks and Workshops' },
              { id: 3, img: '/assets/images/hack.jpeg', alt: 'Hackathons' },
            ].map((item) => (
              <Transition
                key={item.id}
                show={tab === item.id}

...
// //import FeaturesBg from '/assets/images/thumb.png'
...
// //import FeaturesElement from '/assets/images/msg.png'
...
//                 <p className="text-xl text-gray-600">Be inspired to create impactful solutions for Africas challenges using blockchain technology. Come learn, interact and explore the Ugandan blockchain space</p>
//               </div>
//               {/* Tabs buttons */}
...
//                       <Image className="md:max-w-none mx-auto rounded" src='/assets/images/comm.jpeg' width={500} height="462" alt="Features bg" />
...
//                   >
//                     <div className="relative inline-flex flex-col">
//                       <Image className="md:max-w-none mx-auto rounded" src='/assets/images/share.jpeg' width={500} height="462" alt="Features bg" />
//                       {/* <Image className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement} width={500} height="44" alt="Element" style={{ top: '30%' }} /> */}
//                     </div>
//                   </Transition>
//                   {/* Item 3 */}
...
//                   >
//                     <div className="relative inline-flex flex-col">
//                       <Image className="md:max-w-none mx-auto rounded" src='/assets/images/hack.jpeg' width={500} height="462" alt="Features bg" />
//                       {/* <Image className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement} width={500} height="44" alt="Element" style={{ top: '30%' }} /> */}
//                     </div>
//                   </Transition>
//                   </div>
